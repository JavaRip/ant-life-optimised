...
use web_sys::console;
use crate::types::{TileType, Chunk};
use crate::types::ChunkExt;
use crate::worldlogic::{WorldInterface, Worldlogic};

impl WorldInterface for Box<World> {
...
pub struct World {
    ...
    pest_freq: i32,
    pest_start: i32,
    worldlogic: Worldlogic<Box<World>>,
}
...
impl World {
    ...
    pub fn constructor(
        ...
        let mut world = World {
            ...
            pest_freq,
            pest_start,
            worldlogic: Worldlogic::new_uninitialized(),
        };
        let world_logic = Worldlogic::new(Box::new(world.clone())); // Cloning world before passing it
        world.worldlogic = world_logic;
